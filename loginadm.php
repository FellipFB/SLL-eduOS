<?php
/**
 * TecaVirtual - Página de Login Administrativo (Raiz)
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            $stmt = $pdo->prepare("SELECT * FROM `adm_usuarios` WHERE `email` = ?");
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                $error = 'Dados de autenticação inválidos. Utilize as credenciais cadastradas.';
            }
...
<body class="min-h-screen flex items-center justify-center p-4 selection:bg-brand-primary/10 select-none">
    ...
    <div class="w-full max-w-sm" id="login-container">
        ...
        <div class="bg-white p-8 rounded-2xl border border-brand-border editorial-shadow flex flex-col relative overflow-hidden" id="card-box">
            ...
            <form action="loginadm.php" method="POST" class="space-y-5" autocomplete="on">
                <div id="group-username">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="Ex: admin@tecavirtual.com"
                    ...
                    <p class="text-[10px] text-brand-light/80 mt-1.5 italic">Exemplo: admin@tecavirtual.com</p>
                </div>
