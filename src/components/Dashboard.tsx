...
import { Book, Loan, DashboardStats, AdminAccount } from '../types';
...
interface DashboardProps {
  ...
  activeTab: 'acervo' | 'locacao' | 'categorias' | 'admins';
  setActiveTab: (tab: 'acervo' | 'locacao' | 'categorias' | 'admins') => void;
