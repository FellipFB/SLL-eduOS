...
export default function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (username === 'admin@tecavirtual.com' && password === 'admin123') {
        onLogin();
      } else {
        setError('Credenciais inválidas. Use o usuário padrão para demonstração.');
        setLoading(false);
      }
    }, 800);
  };
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="form-group" id="group-username">
            ...
            <p className="text-[10px] text-brand-light/80 mt-1.5 italic">Usuário padrão: admin@tecavirtual.com</p>
          </div>
          ...
          <div className="form-group" id="group-password">
            ...
            <p className="text-[10px] text-brand-light/80 mt-1.5 italic">Senha padrão: admin123</p>
          </div>
